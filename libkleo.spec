...
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/libkleo-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/libkleo-22.04.1.tar.xz.sig
...
%prep
%setup -q -n libkleo-22.04.1
cd %{_builddir}/libkleo-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652679402
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkleo-22.04.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/libkleo/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/libkleo-22.04.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/libkleo/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/libkleo-22.04.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/libkleo/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/libkleo-22.04.1/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/libkleo/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/libkleo-22.04.1/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkleo/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/libkleo-22.04.1/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkleo/31a3d460bb3c7d98845187c716a30db81c44b615
cp %{_builddir}/libkleo-22.04.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/libkleo/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/libkleo-22.04.1/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/libkleo/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Libkleo.so.5.20.1
