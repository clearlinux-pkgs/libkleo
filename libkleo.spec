...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/libkleo-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/libkleo-25.04.1.tar.xz.sig
...
%setup -q -n libkleo-25.04.1
cd %{_builddir}/libkleo-25.04.1
pushd ..
cp -a libkleo-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747157751
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Libkleo.so.6.4.1
/usr/lib64/libKPim6Libkleo.so.6
/usr/lib64/libKPim6Libkleo.so.6.4.1
