...
Version  : 22.08.0
Release  : 48
URL      : https://download.kde.org/stable/release-service/22.08.0/src/libkleo-22.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/libkleo-22.08.0.tar.xz
...
%prep
%setup -q -n libkleo-22.08.0
cd %{_builddir}/libkleo-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661551559
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5Libkleo.so.5.21.0
