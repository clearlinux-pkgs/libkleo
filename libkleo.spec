...
Version  : 24.02.2
Release  : 71
URL      : https://download.kde.org/stable/release-service/24.02.2/src/libkleo-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/libkleo-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/libkleo-24.02.2.tar.xz.sig
...
%setup -q -n libkleo-24.02.2
cd %{_builddir}/libkleo-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712897509
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Libkleo.so.6.0.2
/usr/lib64/libKPim6Libkleo.so.6
/usr/lib64/libKPim6Libkleo.so.6.0.2
