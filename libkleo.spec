...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/libkleo-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/libkleo-24.05.1.tar.xz.sig
...
%setup -q -n libkleo-24.05.1
cd %{_builddir}/libkleo-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718415768
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Libkleo.so.6.1.1
/usr/lib64/libKPim6Libkleo.so.6
/usr/lib64/libKPim6Libkleo.so.6.1.1
