...
Version  : 19.12.0
Release  : 16
URL      : https://download.kde.org/stable/release-service/19.12.0/src/libkleo-19.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/libkleo-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/libkleo-19.12.0.tar.xz.sig
...
%prep
%setup -q -n libkleo-19.12.0
cd %{_builddir}/libkleo-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576581117
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libkleo-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/libkleo/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/libkleo-19.12.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/libkleo/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5Libkleo.so.5.13.0
