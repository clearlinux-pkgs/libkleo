...
Version  : 22.12.1
Release  : 53
URL      : https://download.kde.org/stable/release-service/22.12.1/src/libkleo-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/libkleo-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/libkleo-22.12.1.tar.xz.sig
...
%prep
%setup -q -n libkleo-22.12.1
cd %{_builddir}/libkleo-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673304618
mkdir -p clr-build
pushd clr-build
...
/usr/include/KF5/Libkleo/Libkleo/KeyListView
...
/usr/include/KF5/Libkleo/Libkleo/SystemInfo
...
/usr/include/KF5/Libkleo/libkleo/keylistview.h
...
/usr/include/KF5/Libkleo/libkleo/systeminfo.h
...
/usr/lib64/libKF5Libkleo.so.5.22.1
