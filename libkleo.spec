...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/libkleo-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/libkleo-24.02.0.tar.xz.sig
...
%prep
%setup -q -n libkleo-24.02.0
cd %{_builddir}/libkleo-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710429656
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6Libkleo.so.6.0.0
/usr/lib64/libKPim6Libkleo.so.6
/usr/lib64/libKPim6Libkleo.so.6.0.0
